                ...
                <div class="card border-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="kode_mata_pelajaran" value="{{ $nilai->kode_mata_pelajaran }}" class="form-control" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="">Nilai</label>
                            <input type="text" name="nilai" value="{{ $nilai->nilai }}" class="form-control" readonly>
                        </div>
